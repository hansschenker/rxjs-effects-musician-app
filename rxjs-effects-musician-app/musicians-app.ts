...
import { createAction, ofType } from '../../../src/core/actions';
import { createEffect } from '../../../src/core/effect-creator';
import { mapResponse } from '../../../src/core/operators';
import { createEffectsSystem } from '../../../src/core/effects-runner';
...
export const dispatch = {
  ...
  queryChanged: (query: string) => dispatcher.next(musiciansQueryChanged({ query })),
};
 ...
 */
export function watchFilteredMusicians(callback: (musicians: Musician[]) => void): () => void {
